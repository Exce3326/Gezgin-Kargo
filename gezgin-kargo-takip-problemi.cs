...
namespace ProLab_21
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void YolBul(List<Int32> arananIndisListesi,int[,] matris,int tur)
        {
            ...
            t.topluDijikstra(newMatris, 42, arananIndisListesiCopy, 0);
            richTextBox2.Text += sehirManager.GetSehir(plaka).sehirAdi +"("+ sehirManager.GetSehir(plaka).plaka.ToString()+") ";
                for (int i = 0; i < t.tamYol.Count; i++)
                {
                    ...
                    if (i == 0)
                    {
                        OncekiSehirBilgisi = sehirManager.GetSehir(sehirManager.GetSehir(checkedListBox1.CheckedItems[0].ToString()).plaka);
                    }
                    else
                    {
        ...
        //    mesafeListesiForm.listBox1.Items.Add("Kocaeli");
            ...
            else
            {
                ...
                for (int i = 0; i < temp.Count; i++)
                {
                        ...
                        if (i == 0)
                    {
                        OncekiSehirBilgisi = sehirManager.GetSehir(plaka);
                    }
                    else
                    {
        ...
        {
            plaka = sehirManager.GetSehir(checkedListBox1.CheckedItems[0].ToString()).plaka;
        }
    }
}
